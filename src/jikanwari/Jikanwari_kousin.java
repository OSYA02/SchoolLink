...
@WebServlet(urlPatterns={"/jikanwari/Jikanwari_kousin"})
public class Jikanwari_kousin extends HttpServlet {
    public void doGet(
        ...
        try {
            ...
            try (Connection conn = ds.getConnection()) {
                ...
                // SQL文の作成
                String sql1 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql2 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql3 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql4 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql5 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql6 = "UPDATE Class1_SS SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                ...
                try (PreparedStatement statement = conn.prepareStatement(sql6)) {
                    ...
                    // 更新結果の確認
                    if (rowsAffected > 0) {
                        out.println("<p>６時間目のデータが正常に更新されました。</p>");
                    } else {
                        out.println("<p>データの更新に失敗しました。</p>");
                    }
                }
