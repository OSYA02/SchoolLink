...
@WebServlet(urlPatterns={"/jikanwari/Class1_cup"})
public class Class1_cup extends HttpServlet {
    public void doGet(
        ...
        try {
            ...
            try (Connection conn = ds.getConnection()) {
                ...
                // SQL文の作成
                String sql1 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql2 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql3 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql4 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql5 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql6 = "UPDATE Class1_c SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
