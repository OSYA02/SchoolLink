...
@WebServlet(urlPatterns={"/jikanwari/Class2_aup"})
public class Class2_aup extends HttpServlet {
    public void doGet(
        ...
        try {
            ...
            try (Connection conn = ds.getConnection()) {
                ...
                // SQL文の作成
                String sql1 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql2 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql3 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql4 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql5 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
                String sql6 = "UPDATE Class2_a SET 月 = ?, 火 = ?, 水 = ?, 木 = ?, 金 = ? WHERE 時間 = ?";
