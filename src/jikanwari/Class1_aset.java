...
@WebServlet(urlPatterns={"/jikanwari/Class1_aset"})
public class Class1_aset extends HttpServlet {
    public void doGet (
        ...
        try {
            ...
            PreparedStatement st1=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 0");
            ResultSet rs1=st1.executeQuery();
            PreparedStatement st2=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 0");
            ResultSet rs2=st2.executeQuery();
            PreparedStatement st3=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 0");
            ResultSet rs3=st3.executeQuery();
            PreparedStatement st4=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 0");
            ResultSet rs4=st4.executeQuery();
            PreparedStatement st5=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 0");
            ResultSet rs5=st5.executeQuery();

            PreparedStatement st11=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 1");
            ResultSet rs11=st11.executeQuery();
            PreparedStatement st21=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 1");
            ResultSet rs21=st21.executeQuery();
            PreparedStatement st31=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 1");
            ResultSet rs31=st31.executeQuery();
            PreparedStatement st41=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 1");
            ResultSet rs41=st41.executeQuery();
            PreparedStatement st51=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 1");
            ResultSet rs51=st51.executeQuery();

            PreparedStatement st12=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 2");
            ResultSet rs12=st12.executeQuery();
            PreparedStatement st22=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 2");
            ResultSet rs22=st22.executeQuery();
            PreparedStatement st32=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 2");
            ResultSet rs32=st32.executeQuery();
            PreparedStatement st42=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 2");
            ResultSet rs42=st42.executeQuery();
            PreparedStatement st52=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 2");
            ResultSet rs52=st52.executeQuery();

            PreparedStatement st13=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 3");
            ResultSet rs13=st13.executeQuery();
            PreparedStatement st23=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 3");
            ResultSet rs23=st23.executeQuery();
            PreparedStatement st33=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 3");
            ResultSet rs33=st33.executeQuery();
            PreparedStatement st43=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 3");
            ResultSet rs43=st43.executeQuery();
            PreparedStatement st53=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 3");
            ResultSet rs53=st53.executeQuery();

            PreparedStatement st14=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 4");
            ResultSet rs14=st14.executeQuery();
            PreparedStatement st24=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 4");
            ResultSet rs24=st24.executeQuery();
            PreparedStatement st34=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 4");
            ResultSet rs34=st34.executeQuery();
            PreparedStatement st44=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 4");
            ResultSet rs44=st44.executeQuery();
            PreparedStatement st54=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 4");
            ResultSet rs54=st54.executeQuery();

            PreparedStatement st15=con.prepareStatement("SELECT 月 FROM class1_a LIMIT 1 OFFSET 5");
            ResultSet rs15=st15.executeQuery();
            PreparedStatement st25=con.prepareStatement("SELECT 火 FROM class1_a LIMIT 1 OFFSET 5");
            ResultSet rs25=st25.executeQuery();
            PreparedStatement st35=con.prepareStatement("SELECT 水 FROM class1_a LIMIT 1 OFFSET 5");
            ResultSet rs35=st35.executeQuery();
            PreparedStatement st45=con.prepareStatement("SELECT 木 FROM class1_a LIMIT 1 OFFSET 5");
            ResultSet rs45=st45.executeQuery();
            PreparedStatement st55=con.prepareStatement("SELECT 金 FROM class1_a LIMIT 1 OFFSET 5");
            ...
            out.println("<form action=\"Class1_aup\" method=\"get\">");
