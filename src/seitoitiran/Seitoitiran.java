...
@WebServlet(urlPatterns={"/jikanwari/Seitoitiran"})
public class Seitoitiran extends HttpServlet {
	public void doGet (
		...
		try {
			...
			PreparedStatement st=con.prepareStatement("SELECT * FROM teacher_information WHERE TI_003_year = '3' AND SI_004_class = 'A'");
